...
public static class ShellHelper
{
	...
	public static string GetAdbPath()
	{
		...
		string adbPath = Path.Combine(Path.GetFullPath(sdkRoot), Path.Combine("platform-tools", GetAdbFileName()));
#endif
		return adbPath;
	}
	...
	/// </summary>
	/// <returns> Returns adb's executable name based on platform.</returns>
